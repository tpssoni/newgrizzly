...
public class Product {
	...
	public String toString() {
		return "Product [id=" + id + ", category=" + category + ", name=" + name + ", description=" + description
				+ ", price=" + price + ", brand=" + brand + ", rating=" + rating + ", offer=" + offer + ", getBrand()="
				+ getBrand() + ", getRating()=" + getRating() + ", getOffer()=" + getOffer() + ", getId()=" + getId()
				+ ", getCategory()=" + getCategory() + ", getName()=" + getName() + ", getDescription()="
